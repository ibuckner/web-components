...
| `pre`      | `pre`      | Sets the prefix label to be applied to the element                      | `string`  | `""`        |
| `rag`      | `rag`      | Sets the Red-Amber-Green icon to be applied to the element              | `number`  | `undefined` |
| `ready`    | `ready`    | True when element can correctly respond to external programmatic access | `boolean` | `false`     |
| `suf`      | `suf`      | Sets the suffix label to be applied to the element                      | `string`  | `""`        |
